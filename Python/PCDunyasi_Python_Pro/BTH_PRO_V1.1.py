...
# Compiled at: 2019-05-15 18:34:09
import os
os.system('apt-get install figlet')
os.system('clear')
os.system('figlet BTH PRO V1.1')
yesil = '\x1b[32m'
...
if secim == '1':
    ...
    if btsecim == '1':
        ...
        if ptsecim == '1':
            ...
            os.system('nmap -T4 -F -oN hizli_tarama_' + hthedefip + '.txt ' + hthedefip)
            print ''
            ...
            os.system('nmap -sS -sU -PN -p 1-65535 -oN tum_port_tarama_' + tpthedefip + '.txt ' + tpthedefip)
            print ''
            print yesil + 'Sonu\xc3\xa7lar Kaydedildi.'
            print ''
        elif ptsecim == '4':
...
# okay decompiling pcdunyasi/BTH_PRO_V1.1.pyc
